...
public class Vehicule extends Produit {
    ...
    @ElementCollection
    @CollectionTable(name = "couleur_moteur_vehicule",
    joinColumns = @JoinColumn(name = "vehicule_id"))
    @Column(name = "couleursMotors")
    ...
    @CollectionTable(name = "couleur_moteur_vehicule",
            joinColumns = @JoinColumn(name = "vehicule_id"))
    @Column(name = "couleursMotors")
    private List<String> listCouleursMotorsVelos;
    ...
    @ManyToMany
    @JoinTable(name = "reprise_Veh_Cli",
    joinColumns = @JoinColumn(name = "vehicule_id_clie"),
    inverseJoinColumns = @JoinColumn(name = "clients_Vehi"))
    private List<Client> clientsVeh;
